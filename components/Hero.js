      ...
      <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <div class=" mb-4 font-medium text-white space-y-5">
            ...
            <h3 className="text-3xl pl-3">Hello 👋</h3>
            <h1 className="text-5xl pl-3">I'm Abdulrhman Bokhari</h1>
            <h2 className="text-4xl pl-3">Front End Developer</h2>
            <p className="font-sndFont opacity-25">&#60; &#47; h1 &#62; </p>
          </div>
        ...
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          <img class=" rounded" alt="hero" src="h2.png" />
        </div>
      </div>
    </section>
  );
