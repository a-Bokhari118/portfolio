  ...
  return (
    <section>
      <div className="container mx-auto px-5">
        ...
        <h1 className="text-6xl font-mainFont  bg-gradient-to-tr from-[#2B83BA] to-green-100 text-transparent bg-clip-text">
          About Me
        </h1>

        <p class="mb-8  text-gray-400 w-[60%] text-2xl leading-relaxed">
